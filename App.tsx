    ...
    <div className="flex flex-col h-screen bg-slate-950 text-slate-100 font-sans">
      <header className="bg-slate-900 border-b border-slate-800 p-4 flex justify-between items-center shadow-lg z-10">
        <div className="flex items-center space-x-3">
           ...
           <h1 className="text-xl font-bold tracking-tight">OODA Loop Simulation</h1>
        </div>
      ...
      <main className="flex-grow flex overflow-hidden">
        ...
        <div className="w-1/4 p-4 overflow-y-auto space-y-4 bg-slate-900 border-r border-slate-800">
        ...
        <div className="w-1/2 p-4 overflow-y-auto bg-slate-950 flex flex-col">
          <h2 className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Environment</h2>
          <WorldMap agents={agents.filter(a => worldTime >= a.spawnTime || (worldTime < a.spawnTime && a.spawnTime > 24))} market={market} />
          
          <div className="mt-6">
            <h2 className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Supply Side (Companies)</h2>
